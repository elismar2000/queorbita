...
plt.plot(coords_min1[0], coords_min1[1], 'rX', label='Galaxy 1')
plt.plot(coords_min2[0], coords_min2[1], 'yX', label='Galaxy 2')
plt.plot(coords_min1[0][0], coords_min1[1][0], 'b*')
plt.plot(coords_min2[0][0], coords_min2[1][0], 'b*')
plt.ylabel('y (kpc)')
plt.xlabel('x (kpc)')
